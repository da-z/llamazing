...
const boxStyles = tv({
  ...
  variants: {
    isSelected: {
      false:
        "bg-white/25 dark:bg-black/45 border-[--color] [--color:theme(colors.gray.400)] dark:[--color:colors.zinc.400)] group-pressed:[--color:theme(colors.gray.500)] dark:group-pressed:[--color:theme(colors.zinc.300)]",
