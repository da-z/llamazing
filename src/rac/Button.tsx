...
const button = tv({
  ...
  variants: {
    ...
    isDisabled: {
      true: "bg-gray-100 dark:bg-zinc-800 text-gray-300 dark:text-zinc-600 forced-colors:text-[GrayText] border-black/5 dark:border-white/5 dark:hover:bg-transparent hover:bg-gray-100 hover:text-neutral-300",
    },
  },
  defaultVariants: {
    variant: "primary",
